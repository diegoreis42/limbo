...
use limbo_sqlite3_parser::ast::{self, SortOrder, UnaryOperator};
...
pub fn translate_condition_expr(
    ...
    match expr {
        ...
        ast::Expr::InList { lhs, not, rhs } => {
            ...
            // TODO: include BeginSubrtn and Return
            if rhs.as_ref().unwrap().len() >= 3 {
                // Insert values inside IN list into a temporary index
                ...
                program.emit_insn(Insn::BeginSubrtn { dest: cursor_id, dest_end: None }); // check
                ...
                for expr in rhs.iter() {
                    ...
                    program.emit_insn(Insn::IdxInsertAwait { cursor_id });
                }
