...
impl Affinity {
    ...
    pub fn from_char(c: char) -> Option<Self> {
        match c {
            SQLITE_AFF_INTEGER => Some(Affinity::Integer),
            SQLITE_AFF_TEXT => Some(Affinity::Text),
            SQLITE_AFF_NONE => Some(Affinity::Blob),
            SQLITE_AFF_REAL => Some(Affinity::Real),
            SQLITE_AFF_NUMERIC => Some(Affinity::Numeric),
            _ => None,
        }
    }
}
